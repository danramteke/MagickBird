...
public class Tiler {
  ...
  public init(inputPath: String, outputPath: String, tileSide: Int = 512, outputFilename: @escaping (Int, Int, Int) -> String = { zoom, x, y in "\(zoom)_\(x)_\(y).png" }, tileAdjustmentBlock: ( (Tile) -> Image)? = nil) {
  ...
  public init(input: Image, writer: Writer, tileSide: Int = 512, outputFilename: @escaping (Int, Int, Int) -> String = { zoom, x, y in "\(zoom)_\(x)_\(y).png" }, tileAdjustmentBlock: ( (Tile) -> Image)? = nil) {
    self.writer = writer
